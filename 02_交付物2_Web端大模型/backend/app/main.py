...
# 前端路径
_frontend_path = os.path.normpath(os.path.join(os.path.dirname(__file__), "../../frontend"))
...
async def serve_frontend():
    """服务前端页面"""
    frontend_file = os.path.join(_frontend_path, "index.html")
    if os.path.exists(frontend_file):
        return FileResponse(frontend_file)
    return {"name": "钢箱梁智能助手", "version": "1.0.0", "docs": "/docs"}
